 ...
 *    MQTT-SN Parametrs
 ==================================*/
#define MAX_CLIENTS                 (1000)  // Number of Clients can be handled.
#define MAX_CLIENTID_LENGTH          (64)  // Max length of clientID
#define MAX_INFLIGHTMESSAGES         (100)  // Number of inflight messages
#define MAX_MESSAGEID_TABLE_SIZE    (5000)  // Number of MessageIdTable size
